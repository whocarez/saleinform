<?php /* Smarty version 2.6.10, created on 2009-03-29 21:34:02
...
')" class='inactive_form' oncontextmenu="return showmenu(event, '<?php echo $this->_tpl_vars['name']; ?>
_contextmenu');">
...
<script>TableKit.Resizable.init($('<?php echo $this->_tpl_vars['name']; ?>
_data').down('table'));</script>