...
_magic_number = 5
_modified_time = 1234103267.4530001
_template_filename='D:\\PROJECTS\\ECLIPSE\\PYLONS\\saleinform\\saleinform\\templates/modules/members/register_form.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'</span>\n\t\t</div>\n\n\t\t<div class="registerLine2">\n\t\t\t<label for="captcha">')
        # SOURCE LINE 65
        __M_writer(escape(_(u'\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430, \u0432\u0432\u0435\u0434\u0438\u0442\u0435 \u043a\u043e\u0434, \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u043d\u044b\u0439 \u043d\u0430 \u043a\u0430\u0440\u0442\u0438\u043d\u043a\u0435')))
        __M_writer(u'</label>\n\t\t\t')
        # SOURCE LINE 66
        __M_writer(escape(h.h_tags.password('captcha', value="", id="confirm_password")))
        __M_writer(u'\n\t\t</div>\n\n\t\t<div style="clear: both;">\n\t\t</div>\n\n\t\t<div>\n\t\t\t')
        # SOURCE LINE 73
