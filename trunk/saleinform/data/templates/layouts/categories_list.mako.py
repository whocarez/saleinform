...
_magic_number = 5
_modified_time = 1234305606.914084
_template_filename='/home/mazvv/Projects/Python/Pylons/saleinform/saleinform/templates/layouts/categories_list.mako'
_template_uri='/layouts/categories_list.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\r\n\t\t\t</div>\r\n\t\t\t<div>\r\n\t\t\t\t')
        # SOURCE LINE 27
        runtime._include_file(context, '/modules/categories/list.mako', _template_uri)
        __M_writer(u'\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t<div>\r\n\t\t\t')
        # SOURCE LINE 31
