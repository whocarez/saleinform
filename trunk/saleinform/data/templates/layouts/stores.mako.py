...
_magic_number = 5
_modified_time = 1233244976.4413919
_template_filename='/home/mazvv/Projects/PYLONS/saleinform/saleinform/templates/layouts/stores.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\r\n\t')
        # SOURCE LINE 14
        __M_writer(escape(h.h_tags.stylesheet_link('/css/stores.css')))
        ...
        __M_writer(u'\r\n\t\t\t</div>\r\n\t\t\t<div>\r\n\t\t\t\t')
        # SOURCE LINE 28
        runtime._include_file(context, '/modules/stores/list.mako', _template_uri)
        __M_writer(u'\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t<div>\r\n\t\t\t')
        # SOURCE LINE 32
