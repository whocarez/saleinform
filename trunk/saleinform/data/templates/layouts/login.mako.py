...
_magic_number = 5
_modified_time = 1233957418.4590981
_template_filename='/home/mazvv/Projects/Python/Pylons/saleinform/saleinform/templates/layouts/login.mako'
_template_uri='/layouts/login.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\r\n\t\t\t</div>\r\n\t\t\t<div>\r\n\t\t\t\t')
        # SOURCE LINE 22
        runtime._include_file(context, '/modules/members/login_form.mako', _template_uri)
        __M_writer(u'\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t<div>\r\n\t\t\t')
        # SOURCE LINE 26
