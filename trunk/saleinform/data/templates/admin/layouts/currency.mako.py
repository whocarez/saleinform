...
_magic_number = 5
_modified_time = 1234987116.6013899
_template_filename='/home/mazvv/Projects/Python/Pylons/saleinform/saleinform/templates/admin/layouts/currency.mako'
_template_uri='/admin/layouts/currency.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\r\n\t')
        # SOURCE LINE 14
        __M_writer(escape(h.h_tags.stylesheet_link('/css/admin_currency.css')))
        ...
        # SOURCE LINE 25
        runtime._include_file(context, '/admin/modules/currency/' + (c.a_template_name), _template_uri)
        __M_writer(u'\r\n\t\t\t\t</div>\r\n\t\t\t\t<div>\r\n\t\t\t\t\t')
        # SOURCE LINE 28
        runtime._include_file(context, '/admin/modules/currency/cources_list.mako', _template_uri)
        __M_writer(u'\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t<div>\r\n\t\t</div>\r\n\t</div>\r\n</body>\r\n</html>')
        return ''
    finally:
