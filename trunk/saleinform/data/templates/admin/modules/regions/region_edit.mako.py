...
_magic_number = 5
_modified_time = 1235322471.965126
_template_filename='/home/mazvv/Projects/Python/Pylons/saleinform/saleinform/templates/admin/modules/regions/region_edit.mako'
_template_uri='/admin/modules/regions/region_edit.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 6
        __M_writer(escape(_(u'\u0420\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u0432\u043d\u0438\u0435 \u0440\u0435\u0433\u0438\u043e\u043d\u043e\u0432')))
        __M_writer(u'</h3>\n<div class="back-link">\n\t')
        # SOURCE LINE 8
        ...
        __M_writer(u'\n')
        # SOURCE LINE 20
        __M_writer(escape(h.h_tags.form(url='/admin/regions/rp/%s?_countries_rid=%s'%(c.a_region.rid, c.a_country.rid), method="post", multipart=True, id="regions")))
        __M_writer(u'\n')
        # SOURCE LINE 21
        ...
        __M_writer(u'</label>\n\t\t</td>\n\t\t<td>\n\t\t\t')
        # SOURCE LINE 37
        __M_writer(escape(h.h_tags.text('name', value=c.a_region.name, id="name")))
        __M_writer(u'\n\t\t</td>\n\t</tr>\n\t</table>\n\t')
        # SOURCE LINE 41
