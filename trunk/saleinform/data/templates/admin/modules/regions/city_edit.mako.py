...
_magic_number = 5
_modified_time = 1235324838.448966
_template_filename='/home/mazvv/Projects/Python/Pylons/saleinform/saleinform/templates/admin/modules/regions/city_edit.mako'
_template_uri='/admin/modules/regions/city_edit.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 6
        __M_writer(escape(_(u'\u0420\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 \u0433\u043e\u0440\u043e\u0434\u043e\u0432')))
        __M_writer(u'</h3>\n<div class="back-link">\n\t')
        # SOURCE LINE 8
        ...
        __M_writer(u'\n')
        # SOURCE LINE 20
        __M_writer(escape(h.h_tags.form(url='/admin/regions/cp/%s?_regions_rid=%s'%(c.a_city.rid, c.a_region.rid), method="post", multipart=True, id="cities")))
        __M_writer(u'\n')
        # SOURCE LINE 21
        ...
        __M_writer(u'\n\t\t</td>\n\t</tr>\n\t<tr>\n\t\t<td width="40%">\n\t\t\t<label for="code">')
        # SOURCE LINE 34
        __M_writer(escape(_(u'\u0420\u0435\u0433\u0438\u043e\u043d')))
        __M_writer(u'</label>\n\t\t</td>\n\t\t<td>\n\t\t\t')
        # SOURCE LINE 37
        __M_writer(escape(c.a_region.name))
        __M_writer(u'\n\t\t</td>\n\t</tr>\n\t<tr>\n\t\t<td>\n\t\t\t<label for="name">')
        # SOURCE LINE 42
        __M_writer(escape(_(u'\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u0433\u043e\u0440\u043e\u0434\u0430')))
        __M_writer(u'</label>\n\t\t</td>\n\t\t<td>\n\t\t\t')
        # SOURCE LINE 45
        __M_writer(escape(h.h_tags.text('name', value=c.a_city.name, id="name")))
        __M_writer(u'\n\t\t</td>\n\t</tr>\n\t</table>\n\t')
        # SOURCE LINE 49
