...
_magic_number = 5
_modified_time = 1235324284.865324
_template_filename='/home/mazvv/Projects/Python/Pylons/saleinform/saleinform/templates/admin/modules/regions/city_add.mako'
_template_uri='/admin/modules/regions/city_add.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 6
        __M_writer(escape(_(u'\u0414\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u0433\u043e\u0440\u043e\u0434\u043e\u0432')))
        __M_writer(u'</h3>\n<div class="back-link">\n\t')
        # SOURCE LINE 8
        ...
        __M_writer(u'\n')
        # SOURCE LINE 20
        __M_writer(escape(h.h_tags.form(url='/admin/regions/cp?_regions_rid=%s'%c.a_region.rid, method="post", multipart=True, id="cities")))
        __M_writer(u'\n')
        # SOURCE LINE 21
