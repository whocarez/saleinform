...
_magic_number = 5
_modified_time = 1234644931.239244
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n\t\t</li>\n\t\t<li class="">\n\t\t\t')
        # SOURCE LINE 13
        __M_writer(escape(h.h_tags.link_to(h.h_builder.literal('<span>'+_(u'\u0413\u0435\u043e\u0433\u0440\u0430\u0444\u0438\u044f')+'</span>'), url='/admin/geography', title=_(u'\u0413\u0435\u043e\u0433\u0440\u0430\u0444\u0438\u044f'), rel="dropmenu1_d")))
        __M_writer(u'\n\t\t</li>\n\t\t<li class="">\n\t\t\t')
        # SOURCE LINE 16
