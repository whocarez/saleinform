...
$faq[] = array("Почему меня автоматически отключает?", "Если вы не отметили галочкой пункт <i>Запомнить меня</i>, вы сможете оставаться под своим именем на форуме только некоторое ограниченное время. Это сделано для того, чтобы никто другой не смог воспользоваться вашей учётной записью. Для того, чтобы вас автоматически не отключало от форума, вы можете выбрать пункт <i>Входить автоматически</i>, но мы <b>не рекомендуем</b> вам делать это на общедоступном компьютере, например в библиотеке, интернет-кафе, университете и т.д.");
$faq[] = array("Как сделать, чтобы я не появлялся в списке активных пользователей?", "В настройках вашего профиля вы найдете опцию <i>Скрывать пребывание на форуме</i>, если вы выберете <i>Да</i>, то будете видны только администраторам и самому себе. Для всех остальных вы будете показываться как скрытый пользователь.");
$faq[] = array("Я забыл пароль!", "Не паникуйте! Хотя ваш пароль и не может быть восстановлен, вам может быть присвоен новый. Для этого кликните на <u>Выслать новый пароль</u>, следуйте инструкциям, и скоро вы снова сможете войти на форум");
...
$faq[] = array("Как мне изменить мои настройки?", "Все ваши настройки хранятся в базе данных (если вы зарегистрированы). Чтобы изменить их, перейдите в раздел <u>Ваш профиль</u> (обычно ссылка на него находится вверху форума, но могут быть и исключения). Там вы можете изменить все свои настройки");
...
$faq[] = array("Я изменил часовой пояс, но время все равно неправильное!", "Если вы уверены, что указали часовой пояс правильно, то причина может быть в летнем времени. Если да, то попробуйте включить <i>Зимнее/летнее время</i> у себя в профиле.");
$faq[] = array("Моего языка нет в списке!", "Причина скорее всего в том, что администратор не установил поддержку вашего языка в форуме, или же просто никто не перевёл этот форум на ваш язык. Попробуйте узнать у администратора форума, может ли он установить требуемый язык. Если же поддержки нужного языка пока не существует, то вы сами можете перевести этот форум на свой язык. Дополнительную информацию вы можете получить на сайте Группы useBB (ссылка есть внизу страницы)");
//{TODO}$faq[] = array("Как я могу поместить картинку под своим именем?", "Под именем пользователя может быть картинка, которая называется &laquo;аватара&raquo;. Эта картинка обычно уникальна для каждого пользователя. От администраторов зависит, включена ли поддержка аватар. Если в данном форуме не включена поддержка аватар, то это решение администраторов, вы можете выяснить у них причины.");
...
$faq[] = array("Когда я щёлкаю по ссылке &laquo;Отправить e-mail&raquo;, от меня требуют войти?", "Только зарегистрированные пользователи могут посылать e-mail через встроенную в форум форму (если эта возможность вообще разрешена администратором). Это сделано для того, чтобы предотвратить злоупотребления системой e-mail анонимными пользователями.");
...
$faq[] = array("Как присоединить подпись к моему сообщению?", "Для того, чтобы присоединить подпись, вы должны сначала создать её в своем профиле. После создания вы должны отметить галочкой пункт <i>Использовать подпись</i> в форме отправки сообщения, чтобы подпись добавилась. Вы также можете сделать чтобы подпись присоединялась по умолчанию, если отметите соответствующий пункт в вашем профиле (вы сможете отключать подпись в определенных сообщениях, убрав галочку <i>Присоединить  подпись</i>)");
...
$faq[] = array("--","Информация о UseBB");
$faq[] = array("Кто написал этот форум?", "Это программное обеспечение (в его исходной форме) написано и распространяется <a href=\"http://www.usebb.net/\" target=\"_blank\">Группой UseBB</a>, ей и принадлежат авторские права на него. Этот форум выпускается под лицензией GNU General Public Licence и может свободно распространяться, за дополнительной информацией смотрите ссылку вверху");
$faq[] = array("С кем можно связаться по вопросу некорректного использования и юридических вопросов, связанных с этим форумом?", "Вы должны связаться с администратором данного форума. Если вы не можете выяснить, кто является администратором, то сперва свяжитесь с модератором и спросите у него, с кем вы можете связаться по данному вопросу. Если и теперь вы не получили ответа, свяжитесь с владельцем домена (сделайте whois lookup) или, если форум запущен на бесплатном домене (например chat.ru, yahoo, free.fr, f2s.com, etc.), с техподдержкой данного домена. Пожалуйста, учтите, что Группа UseBB не имеет никакого контроля над данным форумом, и не может нести никакой ответственности за то кем и как данный форум используется. Абсолютно бессмысленно обращаться к Группе UseBB по юридическим вопросам (по приостановке форума, ответственности за него и т.д.), которые не относятся напрямую к вебсайту usebb.net, или которые частично относятся к программному обеспечению UseBB группы. Если же вы все-таки пошлёте e-mail Группе UseBB об использовании третьей стороной данного форума, то не ждите подробного письма, или вы можете вообще не получить ответа.");
?>
