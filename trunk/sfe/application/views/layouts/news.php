...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url()?>javascript/yui/build/yahoo/yahoo.js"></script> 
	<script type="text/javascript" src="<?php echo base_url()?>javascript/yui/build/event/event.js"></script>  
	<script type="text/javascript" src="<?php echo base_url()?>javascript/yui/build/container/container_core.js"></script>  
	<script type="text/javascript" src="<?php echo base_url()?>javascript/yui/build/dom/dom.js"></script>  
	<script type="text/javascript" src="<?php echo base_url()?>javascript/yui/build/animation/animation.js"></script> 
