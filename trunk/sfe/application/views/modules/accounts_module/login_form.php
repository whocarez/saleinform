...
<table cellspacing="1" cellpadding="0" class="wd750nopad bg12dark">
	...
	<tr>
		<td class="loginCOL1 bg12light">
			...
			<div class="padT5">				<?=form_button('submit', lang('ACCOUNTS_MODULE_REGISTRATION_TITLE').' >', 'size="40", class="w150" onclick="javascript: window.location = \''.base_url().index_page().'/accounts/register\'"')?>			</div>
		</td>
		<td class="loginCOL2 bgwhite">
			...
			<?=form_password('password', "", 'tabindex="2", maxlength="255", size="20"')?><br>			<?=anchor('accounts/restorepass', lang('ACCOUNTS_MODULE_PASSWORD_FORGOT_TITLE'), 'title="'.lang('ACCOUNTS_MODULE_PASSWORD_FORGOT_TITLE').'"')?><br>			<span class="subgrey"><?=lang('ACCOUNTS_LOGIN_6')?></span><br>
			<!--
