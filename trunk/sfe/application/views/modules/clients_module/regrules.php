<div id="Node_BreadCrumb" class="breadCrumb2-US">
	...
	<span class="grey">></span>
	<span class="greyb">
		<?=lang('CLIENTS_ADD_RULES')?>
	</span>
</div>
<div class="add-client-box">
	<?=lang('CLIENTS_MODULE_CLIENTS_ADD_CLIENT_DESCR')?>
	<br>	<a href="<?=base_url()?>pub/anketa.doc" target="_blank" title="<?=lang('CLIENTS_MODULE_CLIENTS_ADD_GOREGISTER')?>" ><?=lang('CLIENTS_MODULE_CLIENTS_ADD_GOREGISTER')?></a>
