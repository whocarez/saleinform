        ...
        foreach ($forest as $tree)
        {
			...
			if (count($tree['childNodes']))
			{
				...
				{ 
					...
					{
						$empty = false;
						echo '<td colspan="2" style="border-bottom: 1px dashed black;"><span><strong>'.$tree['name'].'</strong></span></td>';
						break;
					} 
				}   
			}
			...
			{
				if($tree['value']) echo '<td  width="50%" style="font-size:90%;">&nbsp;&nbsp;&nbsp;&nbsp;'.$tree['name'].'</td><td width="50%"><font style="color:#888888; font-size: 8pt;">'.$tree['value'].'</font></td>';
			}
