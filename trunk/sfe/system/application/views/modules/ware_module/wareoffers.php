	<div class="box">
		<div class="b_h">
			...
			<a href="<?php echo $ware_offers_detailed_link?>" id="news_1" class="rCG">
				<span id="news_1text"><?php echo $ware_detailed_info_tab_title?></span>
			</a>
			<a href="<?php echo $ware_offers_offers_link?>" id="news_0" class="rC" >
				...
				<div class="o" id="news_c" style="">
					<div id="news_cnt">
						<div style="padding: 5px;" id="themes_cnt">
							...
							<div>
								<?php echo $ware_offers_header_sortby_dropdown;?>
							</div>
							<div class="n_fb">
								<?php echo $ware_offers_table;?>
							</div>
						</div>
						<?php echo $ware_offers_pagination;?>
					</div>
				</div>
			</div>
		</div>