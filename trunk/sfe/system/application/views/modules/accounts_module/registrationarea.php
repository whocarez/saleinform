					<div class="box">
						<div class="b_h">
							<div id="hc_market" class="b_hc" >
								<?php echo $accounts_registration_title;?>
							</div>
						</div>
										...
										<tbody>
											<tr>
												<td colspan="99" style="padding-left: 0px;" >
													<div class="n_fb">
														<img src="<?php echo base_url()?>images/icons/0186_32x32.png" align="left" hspace="5" width="32" height="32">
														<?php echo $accounts_registration_note;?>
													</div>
												</td>
											</tr>
											<tr>
												<td style="padding-left: 0px;" nowrap="nowrap" width="60%">
													<div style="width: 100%;">
														<div style="float: left;">
															<?php echo $accounts_display_name_label?>
														</div>
													</div>
												</td>
												<td>
													<input name="display_name" style="width:150px" class="i" value="<?php echo $this->validation->display_name?>" type="text">
													<?php echo $this->validation->display_name_error;?>
												</td>
											</tr>
											<tr>
												<td style="padding-left: 0px;" nowrap="nowrap" width="60%">
											...
											<tr>
												<td style="padding-left: 0px;" nowrap="nowrap" width="60%">
													<div style="width: 100%;">
														<div style="float: left; width: 60%;">
															<?php echo $accounts_password_label?>
														</div>
													</div>
												</td>
												<td style="padding-left: 0px;">
											...
											<tr>
												<td style="padding-left: 0px;" nowrap="nowrap" width="60%">
													<div style="width: 100%;">
														<div style="float: left; width: 60%;">
															<?php echo $accounts_email_label?>
														</div>
													</div>
												</td>
												<td style="padding-left: 0px;">
													<input name="email" style="width:150px" class="i" value="<?php echo $this->validation->email?>" type="text">
