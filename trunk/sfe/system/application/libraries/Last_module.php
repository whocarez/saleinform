...
class Last_module 
{
	...
	public function RenderLastArea()
	{
		$this->objectsArr['last_module_area_title'] = $this->STN_last_module_area_title;
		$this->objectsArr['last_module_news_area_tab'] = $this->STN_last_news_area_title;
		$this->objectsArr['last_module_opinions_area_tab'] = $this->STN_last_opinions_area_title;
		$this->objectsArr['last_module_reviews_area_tab'] = $this->STN_last_reviews_area_title;
		$this->objectsArr['last_module_wdetails_area_tab'] = $this->STN_last_wdetails_area_title;
		$this->ciObject->benchmark->mark('last_news_area_start');
		$this->objectsArr['last_module_news_area_content'] = $this->_RenderLastNewsArea();
		$this->ciObject->benchmark->mark('last_news_area_end');
		$this->ciObject->benchmark->mark('last_opinions_area_start');
		$this->objectsArr['last_module_opinions_area_content'] = $this->_RenderLastOpinionsArea();
		$this->ciObject->benchmark->mark('last_opinions_area_end');
		$this->ciObject->benchmark->mark('last_reviews_area_start');
		$this->objectsArr['last_module_reviews_area_content'] = $this->_RenderLastReviewsArea();
		$this->ciObject->benchmark->mark('last_reviews_area_end');
		#$this->ciObject->benchmark->mark('last_wdetails_area_start');
		$this->objectsArr['last_module_wdetails_area_content'] = $this->_RenderLastWdetailsArea();
		#$this->ciObject->benchmark->mark('last_wdetails_area_end');
		return $this->ciObject->load->view('modules/last_module/lastarea.php',$this->objectsArr, True);
	}

	public function _RenderLastNewsArea()
	{
		...
		{ 
			...
			$resultARR[$key]['new'] = character_limiter(stripslashes($resultARR[$key]['new']), 256);
