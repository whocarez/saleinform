...
class Help extends Controller 
{
	...
	public function ShowHelpArea()
	{
		$this->objectsArr['help_area_obj'] = $this->help_module->RenderHelpArea();
		$this->objectsArr['keywords_area_obj'] = $this->keywords_module->RenderKeywordsArea($this->objectsArr['help_area_obj']);		
