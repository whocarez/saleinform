 ...
 * The Wareuopinions
*/
class Wareuops extends Controller 
{
	...
	public function __construct()
	{
		...
		$this->load->library('wareuops_module');
	...
	{
		$this->objectsArr['wareuops_area_obj'] = $this->categories_module->RenderCategoriesList();
		$this->objectsArr['keywords_area_obj'] = $this->keywords_module->RenderKeywordsArea($this->objectsArr['wareuops_area_obj']);
		$this->load->view('layouts/wareuops.php', $this->objectsArr);
	}
	...
	public function _remap($methodNAME)
	{
		if($methodNAME=='c')
		{
			$this->ShowWareOpinion();	
		}
		else $this->index();
	}
	
	public function ShowWareOpinion()
	{
		$this->objectsArr['wareuops_area_obj']=$this->wareuops_module->RenderWareOpinionsArea();
