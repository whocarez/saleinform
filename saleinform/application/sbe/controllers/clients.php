...
class Clients extends Crmcontroller {
	...
	private function set_validation(){
		...
		$this->form_validation->set_rules('passp_num', lang('PASSP_NUM'), 'trim|exact_length[6]|numeric');
		$this->form_validation->set_rules('f_pass_seria', lang('FPASSP_SERIA'), 'trim|exact_length[2]');
		$this->form_validation->set_rules('f_pass_num', lang('FPASSP_NUM'), 'trim|exact_length[6]|numeric');
		$this->form_validation->set_rules('passp_out', lang('PASSP_OUT'), 'trim|max_length[512]');
