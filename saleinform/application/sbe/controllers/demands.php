...
class Demands extends Doccontroller {
	public function __construct(){
		...
		$this->load->helper('api/touroperators');
		$this->load->helper('api/advertisessources');
		$this->load->helper('api/curourts');
		$this->load->helper('api/hotelscats');
		$this->load->helper('api/rooms');
		$this->load->helper('api/food');
		$this->load->helper('api/clients');
		$this->load->helper('api/finjournal');
		$this->load->helper('api/calls');
	...
	private function set_validation(){
		...
		$this->form_validation->set_rules('_countries_rid', lang('COUNTRY'), 'trim|required');
		...
		$this->form_validation->set_rules('_hotelscats_rid', lang('HOTELCAT'), 'trim|required');
		$this->form_validation->set_rules('hotel_name', lang('HOTEL'), 'trim|required');
