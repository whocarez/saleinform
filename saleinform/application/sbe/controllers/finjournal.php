...
class Finjournal extends Crmcontroller {
	...
	public function __construct(){
		...
		$this->load->helper('api/accountstates');
		$this->load->helper('api/finjournal');
		
		$this->load->helper('api/clients');
		$this->load->helper('api/filials');
		$this->load->helper('api/touroperators');
		$this->load->helper('api/employeers');
		$this->load->helper('api/finjournal');
	}
	...
	protected function remove(){
		...
		redirect(get_currcontroller()."/journal/{$rid}/mrid/".get_curririd(), 'refresh');
	}
