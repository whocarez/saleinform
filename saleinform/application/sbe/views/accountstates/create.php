...
<div class="column span-8">
	<?=form_input('code', set_value('code', ''), 'id="code" class="text"  style="width:60px;"')?>
</div>
...
<div class="column span-8 last">
	<?=form_input('state_name', set_value('state_name', ''), 'id="state_name" class="text" ')?>
</div><div class="column span-4">	<?=form_label(lang('TYPE'), 'koef')?> <font color="red">*</font></div><div class="column span-20 last">	<?=form_dropdown('koef', get_koef_list(), set_value('koef', ''), 'id="koef" class="text" ')?></div>
<div class="column span-4">
