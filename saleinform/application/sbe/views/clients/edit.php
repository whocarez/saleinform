...
<h3><?=$title?></h3>
<?= form_open_multipart(get_currcontroller()."/edit/{$rid}/mrid/".get_curririd(), array('id'=>'edit_'.$orid, 'autocomplete'=>'off'))?>
...
<div class="column span-20 last">
	<?=form_input('card_num', set_value('card_num', $ds->card_num), 'id="card_num" class="text" style="width:80px;"')?>
</div>
...
<fieldset>
	...
	<div class="column span-20 last">
		<?=form_input('f_pass_period', set_value('f_pass_period', $ds->f_pass_period), 'id="f_pass_period" class="text" readonly="readonly" style="width:90px;"')?>
		<script type="text/javascript">
...
<div class="column span-24  last" id="history">
	<?=get_client_history($rid)?>
</div>
</fieldset>
