...
<div class="column span-8 last">
	<?=form_input('city_name_lat', set_value('city_name_lat', $ds->city_name_lat), 'id="city_name_lat" class="text" readonly="readonly"')?>
</div>
...
<div class="column span-24 last">
	<input type="reset" value="<?=lang('CANCEL')?>" class="button" onclick="window.location='<?=site_url(get_currcontroller().'/vdetails/go/mrid/'.get_curririd()) ?>';" id="reset" name="reset">
