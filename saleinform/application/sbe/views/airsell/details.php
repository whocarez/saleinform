...
<fieldset>
	...
	<div class="column span-9 last">
		<?=form_input('date_doc', date_conv(set_value('date_doc', $ds->date_doc)), 'id="date_doc" readonly="readonly" class="text" readonly="readonly" style="width:90px;"')?>
	</div>	
...
<div class="column span-21 last">
	<?=form_input('dnum', set_value('dnum', $ds->dnum), 'id="dnum" readonly="readonly" class="text"')?>
</div>
...
<div class="column span-9">
	<?=form_input('source_name', get_sourcename_byrid(set_value('_advertisessources_rid', $ds->_advertisessources_rid)), 'id="source_name" class="text" readonly="readonly"')?>
</div>
<div class="column span-3">
...
<div class="column span-9 last">
	...
	<?=form_input('aircall_rid', set_value('_aircalls_documents_rid', $ds->_aircalls_documents_rid), 'id="aircall_rid" readonly="readonly" class="text" style="width: 70px;"')?>
</div>
...
<div class="column span-21 last">
	<?=form_input('client_name', get_clientname_byrid(set_value('_clients_rid', $ds->_clients_rid)), 'id="client_name" class="text" readonly="readonly" style="width:200px;"')?>
</div>	
...
<div class="column span-21 last">
	<?=form_dropdown('issue', get_airissues_types(), set_value('issue', $ds->issue), 'id="issue" readonly="readonly" class="text"')?>
</div>
...
<div class="column span-9">
	<?=form_input('bill_code', set_value('bill_code', $ds->bill_code), 'id="bill_code" readonly="readonly" class="text" style="width:50px;"')?>
</div>
...
<div class="column span-9 last">
	<?=form_input('bill_num', set_value('bill_num', $ds->bill_num), 'id="bill_num" readonly="readonly" class="text" ')?>
</div>
...
<div class="column span-21 last">
	<?=form_input('brone_locator', set_value('brone_locator', $ds->brone_locator), 'id="brone_locator" readonly="readonly" class="text" ')?>
</div>
...
<div class="column span-9">
	<?=form_input('sum', set_value('sum', $ds->sum), 'id="sum" class="text" readonly="readonly"')?>
</div>
<div class="column span-3">
