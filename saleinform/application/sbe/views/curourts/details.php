...
<div class="column span-8">
	<?=form_input('curourt_name', set_value('curourt_name', $ds->curourt_name), 'id="curourt_name" class="text" readonly="readonly"')?>
</div>
<div class="column span-4">
	<?=form_label(lang('NAME_LAT'), 'curourt_name_lat')?>
</div>
<div class="column span-8 last">
	<?=form_input('curourt_name_lat', set_value('curourt_name_lat', $ds->curourt_name_lat), 'id="curourt_name_lat" class="text" readonly="readonly"')?>
</div>
