...
<div class="column span-21 last">
	...
	<?=form_checkbox('_hotelscats_rid[]', $cat->rid, $this->input->post('_hotelscats_rid')?in_array($cat->rid, $this->input->post('_hotelscats_rid')):False, 'id="_hotelscats_rid[]"')?> <?=$cat->hotelcat_name?><br>
	<? } ?>
</div>	
...
<div class="column span-19 last">
	<?=form_textarea('tourists_wish', set_value('tourists_wish', ''), 'id="tourists_wish" class="text" style="width: 400px; height:60px;"')?>
</div>
<div class="column span-5">
	<?=form_label(lang('TOURISTS_OFFERS'), 'tourists_offers')?> <font color="red">*</font>
</div>
<div class="column span-19 last">
	<?=form_textarea('tourists_offers', set_value('tourists_offers', ''), 'id="tourists_offers" class="text" style="width: 400px; height:60px;"')?>
</div>
<div class="column span-5">
	<?=form_label(lang('TOURISTS_ANSWERS'), 'tourists_answers')?> <font color="red">*</font>
</div>
<div class="column span-19 last">
	<?=form_textarea('tourists_answers', set_value('tourists_answers', ''), 'id="tourists_answers" class="text" style="width: 400px; height:60px;"')?>
</div>
