...
<div class="column span-9 last">
	<?=form_input('filial_name', get_filial_name_byrid(set_value('_filials_rid', $ds->_filials_rid)), 'id="filial_name" class="text" readonly="readonly" style="width:150px;"')?>
</div>
...
<div class="column span-9">
	<?=form_input('salary', set_value('salary', $ds->salary), 'id="salary" class="text" readonly="readonly" ')?>
</div>
