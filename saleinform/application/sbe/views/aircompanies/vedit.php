...
<div class="column span-20 last">
	<?=form_input('code', set_value('code', $ds->code), 'id="code" class="text" style="width: 30px;"')?>
</div>
...
<div class="column span-4">
	<?=form_label(lang('IATA'), 'iata')?> <font color="red">*</font>
</div>
<div class="column span-20 last">
	<?=form_input('iata', set_value('iata', $ds->iata), 'id="iata" class="text" style="width: 30px;"')?>
</div>
