...
<div class="column span-9">
	<?=form_input('curourt_name', get_curourtname_byrid(set_value('_curourts_rid', $ds->_curourts_rid)), 'id="curourt_name" class="text" readonly="readonly" style="width:150px;"')?>
</div>
<div class="column span-3">
	<?=form_label(lang('ROUTE'), 'route')?> 
</div>
<div class="column span-21 last">
	<?=form_textarea('route', set_value('route', $ds->route), 'class="text" id="route" readonly="readonly" style="width:400px;height:30px;"')?>
</div>	
...
<div class="column span-3">
	<?=form_label(lang('HOTEL'), 'hotel_name')?> 
</div>
<div class="column span-9 last">
	<?=form_input('hotel_name', set_value('hotel_name', $ds->hotel_name), 'class="text" readonly="readonly" id="hotel_name"')?>
</div>	
...
<div class="column span-9">
	<?=form_input('room_cat', set_value('room_cat', $ds->room_cat), 'class="text" readonly="readonly" id="room_cat"')?>
</div>
<div class="column span-3">
	<?=form_label(lang('TRANSFER'), 'transfer')?> 
</div>
<div class="column span-9 last">
	<?=form_textarea('transfer', set_value('transfer', $ds->transfer), 'class="text" id="transfer" readonly="readonly" style="width:300px;height:40px;"')?>
</div>	
<div class="column span-3">
	<?=form_label(lang('EXCURSIONS'), 'excursions')?> 
</div>
<div class="column span-21 last">
	<?=form_textarea('excursions', set_value('excursions', $ds->excursions), 'class="text" readonly="readonly" id="excursions" style="width:400px;height:40px;"')?>
</div>
<div class="column span-3">
	<?=form_label(lang('CIF'), 'cif')?>
</div>
<div class="column span-21 last">
	<?=form_textarea('cif', set_value('cif', $ds->cif), 'class="text" id="cif" readonly="readonly" style="width:400px;height:40px;"')?>
</div>
...
<div class="column span-21 last">
	<?=form_input('tour_num', set_value('tour_num', $ds->tour_num), 'class="text" readonly="readonly" id="tour_num"')?>
</div>	
