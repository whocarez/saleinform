...
<?}?>
<div class="column span-4">	<?=form_label(lang('CODE'), 'country_code')?> <font color="red">*</font></div><div class="column span-20 last">	<?=form_input('country_code', set_value('country_code', $ds->country_code), 'id="country_code" class="text" style="width: 60px;"')?></div><div class="column span-4">	<?=form_label(lang('NAME'), 'country_name')?> <font color="red">*</font></div><div class="column span-8">	<?=form_input('country_name', set_value('country_name', $ds->country_name), 'id="country_name" class="text"')?></div><div class="column span-4">	<?=form_label(lang('NAME_LAT'), 'country_name_lat')?> <font color="red">*</font></div><div class="column span-8 last">	<?=form_input('country_name_lat', set_value('country_name_lat', $ds->country_name_lat), 'id="country_name_lat" class="text"')?></div>
