...
<div class="column span-9">
	<?=form_input('user_login', set_value('user_login', $ds->user_login), 'id="user_login" readonly="readonly" class="text"')?>
</div>
<div class="column span-3" style="white-space: nowrap;">
	<?=form_label(lang('USER_PASSWORD'), 'user_passwd')?>
</div>
<div class="column span-9 last">
	<?=form_password('user_passwd', set_value('user_passwd', $ds->user_passwd), 'id="user_passwd" readonly="readonly" class="text"')?>
</div>
