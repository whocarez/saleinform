...
<div class="column span-8">
	<?=form_input('contract_period', set_value('contract_period', $ds->contract_period), 'id="contract_period" class="text" style="width: 90px;" readonly="readonly"')?>
	<script type="text/javascript">
		$('#contract_period').datepick({showOn: 'button', 
