...
<div class="column span-8 last">
	<?=form_input('oper_date', date_conv(set_value('oper_date', $ds->oper_date)), 'id="oper_date" class="text" readonly="readonly" style="width:90px;"')?>
...
<div class="column span-24 last">
	<input type="submit" value="<?=lang('SAVE')?>" class="button" id="submit" name="submit"> <input type="reset" value="<?=lang('CANCEL')?>" class="button" onclick="window.location='<?=site_url(get_currcontroller().'/journal/'.$ds->_documents_rid.'/mrid/'.get_curririd()) ?>';" id="reset" name="reset">
</div>
