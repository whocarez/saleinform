...
<div class="column span-24 last">
	<input type="reset" value="<?=lang('CANCEL')?>" class="button" onclick="window.location='<?=site_url(get_currcontroller().'/journal/'.$ds->_documents_rid.'/mrid/'.get_curririd()) ?>';" id="reset" name="reset">
</div>
