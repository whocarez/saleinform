...
<div class="column span-9 last">
	<?=form_input('currency_name', set_value('currency_name', ''), 'id="currency_name" class="text"')?>
</div>
...
<div class="column span-9">
	<?=form_input('left_word', set_value('left_word', ''), 'id="left_word" class="text"')?>
</div>
<div class="column span-3">
	<?=form_label(lang('RIGHT_WORD'), 'right_word')?> <font color="red">*</font>
</div>
<div class="column span-9 last">
	<?=form_input('right_word', set_value('right_word', ''), 'id="right_word" class="text"')?>
</div>
