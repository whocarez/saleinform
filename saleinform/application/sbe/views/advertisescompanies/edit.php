...
<div class="column span-4">	<?=form_label(lang('COMPANY'), 'company_name')?> <font color="red">*</font></div><div class="column span-8 last">	<?=form_input('company_name', set_value('company_name', $ds->company_name), 'id="company_name" class="text"  style="width: 150px;"')?></div><div class="column span-4">	<?=form_label(lang('COMPANY_TYPE'), 'company_type')?> <font color="red">*</font></div><div class="column span-8 last">	<?=form_dropdown('company_type', get_advcompaniestypes_list(), set_value('company_type', $ds->company_type), 'id="company_type" class="text" ')?></div>
<div class="column span-4">
